    ...
    extendedMapList.forEach((map, idx) => {
        ...
        card.innerHTML = `
            ...
            <div class="map-card-overlay">
                <div style="font-size: 10px; color: #ff4655; font-weight: 800; letter-spacing: 2px;">VALORANT</div>
                <div>
                    <div style="font-size: 11px; color: rgba(255,255,255,0.7); font-weight: 700; letter-spacing: 1px;">${map.enName}</div>
